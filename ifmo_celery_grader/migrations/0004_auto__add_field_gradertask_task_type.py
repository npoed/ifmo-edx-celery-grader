...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GraderTask.task_type'
        db.add_column('ifmo_celery_grader_gradertask', 'task_type',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GraderTask.task_type'
        db.delete_column('ifmo_celery_grader_gradertask', 'task_type')
    ...
    models = {
        'ifmo_celery_grader.gradertask': {
            ...
            'task_type': ('django.db.models.fields.TextField', [], {'max_length': '50', 'null': 'True', 'db_index': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GraderTask.student_input'
        db.add_column('ifmo_celery_grader_gradertask', 'student_input',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding field 'GraderTask.grader_payload'
        db.add_column('ifmo_celery_grader_gradertask', 'grader_payload',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GraderTask.student_input'
        db.delete_column('ifmo_celery_grader_gradertask', 'student_input')

        # Deleting field 'GraderTask.grader_payload'
        db.delete_column('ifmo_celery_grader_gradertask', 'grader_payload')
